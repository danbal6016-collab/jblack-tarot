...
import { CATEGORIES, TAROT_DECK, COUNTRIES, BGMS, SKINS, TIER_THRESHOLDS, ATTENDANCE_REWARDS, RESULT_FRAMES, RESULT_BACKGROUNDS, DEFAULT_STICKERS, TIER_POPUP_TEXT, RK_COLORS, CATEGORY_TRANSLATIONS } from './constants';
...
<div className="relative min-h-screen text-white font-sans overflow-hidden select-none">
  ...
  <div className="flex flex-col items-center justify-center min-h-screen p-4 relative z-10 animate-fade-in pt-20">
    ...
    <div className="flex flex-col h-full overflow-hidden">
        {/* 1. 뒤로가기 버튼 추가 */}
        <button onClick={() => setSettingsMode('MAIN')} className="mb-4 text-sm text-gray-400 hover:text-white text-left shrink-0">← Back</button>
